# -*- coding: utf-8 -*-
"""var_2_AI project part 2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TAWiZSZNCmUPuRz87L-crL_FZ9SqS3v9
"""
...
# Load data
train_data = datasets.ImageFolder('/content/drive/MyDrive/Applied AI/dataset/train', transform=transform)
val_data = datasets.ImageFolder('/content/drive/MyDrive/Applied AI/dataset/val', transform=transform)
test_data = datasets.ImageFolder('/content/drive/MyDrive/Applied AI/dataset/test', transform=transform)
...
for i in ['angry','bored', 'engaged', 'neutral']:
    print('Training {} images are: '.format(i)+str(len(os.listdir('/content/drive/MyDrive/Applied AI/dataset/train/'+i+'/'))))
...
image_path = '/content/drive/MyDrive/Applied AI/dataset/test/angry/angry114.jpg'
