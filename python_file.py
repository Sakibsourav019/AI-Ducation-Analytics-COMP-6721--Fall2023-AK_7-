...
# Get all the paths
data_dir_list = os.listdir('/content/drive/MyDrive/Applied AI/dataset/train')
print(data_dir_list)
path, dirs, files = next(os.walk(r"/content/drive/MyDrive/Applied AI/datset/train/"))
...
for i in ['bored', 'neutral', 'engaged', 'angry']:
    print('number of training "{}" images are: '.format(i)+str(len(os.listdir('/content/drive/MyDrive/Applied AI/dataset/train/'+i+'/'))))

"""**number of test images**"""

for i in ['bored', 'neutral', 'engaged', 'angry']:
    print('number of test "{}" images are: '.format(i)+str(len(os.listdir('/content/drive/MyDrive/Applied AI/dataset/test/'+i+'/'))))
...
for i in image_folder:
    nimages = len(os.listdir('/content/drive/MyDrive/Applied AI/dataset/train/'+i+'/'))
    nimgs[i]=nimages
...
nimgs = {}
for i in image_folder:
    nimages = len(os.listdir('/content/drive/MyDrive/Applied AI/dataset/test/'+i+'/'))
    nimgs[i]=nimages
plt.figure(figsize=(9, 6))
plt.bar(range(len(nimgs)), list(nimgs.values()), align='center')
plt.xticks(range(len(nimgs)), list(nimgs.keys()))
...
data_dir = '/content/drive/MyDrive/Applied AI/dataset/train'  # Replace with your data directory path
...
plt.savefig('/content/drive/MyDrive/Applied AI/dataset/trainimage_grid.png', bbox_inches='tight', pad_inches=0, dpi=300)
plt.show()
